      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Typography variant="h6" sx={{ 
            ...
            Tạo sản phẩm mới hoặc thêm biến thể cho sản phẩm hiện có
          </Typography>
        </Box>
          ...
          <Paper sx={{
            ...
            '&::before': {
              ...
              <Box sx={{
                ...
                <Typography variant="body2" sx={{ color: '#8a7a2a', fontWeight: 500 }}>
                  Chọn cách thêm sản phẩm mới hoặc sử dụng sản phẩm có sẵn
                </Typography>
              </Box>
            ...
            <Paper sx={{
              ...
              <Box sx={{
                ...
                <Typography variant="body2" sx={{ color: '#8a7a2a', fontWeight: 500 }}>
                  Chọn màu sắc, kích cỡ và nhập thông tin cho từng biến thể
                </Typography>
              </Box>
