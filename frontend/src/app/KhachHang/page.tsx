...
export default function KhachHangPage() {
    ...
    // useEffect để cập nhật danh sách đã lọc khi khachHangs thay đổi
    useEffect(() => {
        setFilteredKhachHangs(khachHangs);
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (isEditing) {
                    ...
                    // Cập nhật filteredKhachHangs nếu đang có tìm kiếm
                    setFilteredKhachHangs((prev: any[]) => [...prev, savedKhachHang]);
                                ...
                                {currentKhachHangs.map((kh, idx) => (
                                    ...
                                    >
                                        ...
                                        <span style={{
                                            ...
                                            fontSize: "0.8rem",
                                            fontWeight: 600,
                                            background: kh.trangThai === "Hoạt động" ? "linear-gradient(135deg, #d4f5dd 0%, #a8e6cf 100%)" : "linear-gradient(135deg, #ffe0e0 0%, #ffb3b3 100%)",
                                            color: kh.trangThai === "Hoạt động" ? "#217a39" : "#c0392b",
                                            display: "inline-block",
                                            minWidth: 0,
                                            textAlign: "center",
                                            border: "1px solid",
                                            borderColor: kh.trangThai === "Hoạt động" ? "#a8e6cf" : "#ffb3b3",
