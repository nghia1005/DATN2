                                ...
                                <div className={styles.supportGrid}>
                                    <div className={styles.supportItem}>
                                        ...
                                        <div className={styles.supportInfo}>
                                            ...
                                            <a href="tel:0365175821" className={styles.supportValue}>0365 175 821</a>
                                        </div>
                                    </div>
                                    <div className={styles.supportItem}>
                                        <div className={styles.supportIcon}>🌐</div>
                                        <div className={styles.supportInfo}>
                                            <div className={styles.supportLabel}>Fanpage</div>
                                            <a href="https://facebook.com/solekingstore" target="_blank" rel="noopener noreferrer" className={styles.supportValue}>facebook.com/solekingstore</a>
                                        </div>
                                    </div>
                                    <div className={styles.supportItem}>
                                        <div className={styles.supportIcon}>📺</div>
                                        <div className={styles.supportInfo}>
                                            <div className={styles.supportLabel}>YouTube</div>
                                            <a href="https://youtube.com/@solekingstore" target="_blank" rel="noopener noreferrer" className={styles.supportValue}>youtube.com/@solekingstore</a>
                                        </div>
                                    </div>
                                    <div className={styles.supportItem}>
                                        <div className={styles.supportIcon}>🎵</div>
                                        <div className={styles.supportInfo}>
                                            <div className={styles.supportLabel}>TikTok</div>
                                            <a href="https://tiktok.com/@solekingstore" target="_blank" rel="noopener noreferrer" className={styles.supportValue}>tiktok.com/@solekingstore</a>
                                        </div>
                                    </div>
                                    <div className={styles.supportItem}>
                                        <div className={styles.supportIcon}>✉️</div>
                                        <div className={styles.supportInfo}>
                                            <div className={styles.supportLabel}>Email</div>
                                            <a href="mailto:support@solekingstore.vn" className={styles.supportValue}>support@solekingstore.vn</a>
                                        </div>
                                    </div>
                                    <div className={styles.supportItem}>
                                        <div className={styles.supportIcon}>🏠</div>
                                        <div className={styles.supportInfo}>
                                            <div className={styles.supportLabel}>Địa Chỉ</div>
                                            <div className={styles.supportValue}>13 P. Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
