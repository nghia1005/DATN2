        ...
        try {
            if (mailSender != null) {
                ...
                String htmlContent =
                    ...
                    "  <p style='margin-bottom: 15px;'>🌐 Website: <a href='http://localhost:3002/shop' style='color: #cbb86c; text-decoration: none;'>www.solekingstore.com</a></p>" +
